...
ThemeData lightTheme = ThemeData(
  ...
  ), colorScheme: ColorScheme.fromSwatch().copyWith(secondary: COLOR_BACKGROUND_LIGHT, background: COLOR_BACKGROUND),
);
...
ThemeData darkTheme = ThemeData(
  ...
  ), colorScheme: ColorScheme.fromSwatch(brightness: Brightness.dark).copyWith(background: COLOR_BACKGROUND_DARK),
);
